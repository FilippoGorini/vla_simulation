...
def launch_setup(context, *args, **kwargs):
    ...
    pkg_share = get_package_share_directory('vla_simulation')
    ...
    robot_description_content = Command(
        [
            ...
            " ",
            PathJoinSubstitution(
                [FindPackageShare("vla_simulation"), "urdf", description_file]  # HARDCODED NEW XACRO
            ),
            " ",
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_file",  
            default_value="vla_kinova.urdf.xacro",
